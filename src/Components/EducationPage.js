  ...
  return (
    <div>
      <div className="education-box">
        ...
        <button onClick={() => handleViewPhotosClick("diploma")}>
          {showDiplomaPhotos ? "Close Info" : "View Info"}
        </button>
        <br />
        <br />
      </div>
      ...
      <div className="education-box">
        ...
        {showBEPhotos && (
          <div>
            <h2>
              With many surgical efforts and hardworks I have Successfully
              Completed my Bachelor of Engineering(Under Graduation) in
              Electronics and Communication engineering(E&C)under VTU:
        ...
        <button onClick={() => handleViewPhotosClick("be")}>
          {showBEPhotos ? "Close Info" : "View Info"}
        </button>{" "}
        <br />
        <br />
      </div>
      ...
      <div className="education-box">
        ...
        {showMTechPhotos && (
          <div>
            <h1>
              Completed Masters of Technology(Post Graduation) in Electronics
              and Communication engineering(E&C)
            </h1>
            <Col md={5} style={{ paddingBottom: 20 }}>
              <img
                src={meone}
        ...
        <button onClick={() => handleViewPhotosClick("mtech")}>
          {showMTechPhotos ? "Close Info" : "View Info"}
        </button>
        <br />
        <br />
      </div>
