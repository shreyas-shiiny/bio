...
const Hobbies = () => {
  ...
  return (
    ...
    <br/><br/>
<h3> Caution:please wait ಶಾಯರಿ 7 and 8 will be updated soon  </h3>
    <h3> Thank-you</h3>
      <div>
        <h3>ಶಾಯರಿ 1</h3>
        {showPoetryOne && (
      ...
      <div>
        ...
        {showPoetrySix && (
          <div>
            <h3>ಎಲ್ಲಾರು ಹೇಳುತ್ತಾರೆ ನಾನು ಒಳ್ಳೆ ಹುಡುಗ ಅಂತೆ<br />
                ನಾನು ಇದ್ದರೆ ನಿನ್ನ ಜೊತೆ <br />
                ಮಾಡಬೇಡ ನೀ ಚಿಂತೆ  <br />
                ಎದುರಿಗೆ ಬಂದರೂ ಕೂಡ ಚಿರತೆ<br />
                ನಾ ಕಾಯುವ ನಿನ್ನನ್ನು ನೀನು ಅಂದುಕೊಂಡಂತೆ</h3>
            <Col md={5} style={{ paddingBottom: 20 }}>
              <img
                src={pot6}
                alt="home pic"
